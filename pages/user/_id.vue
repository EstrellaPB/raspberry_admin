                    ...
                    <div class="card card-profile shadow">
                        ...
                        <div class="card-body pt-5">
                            <div class="justify-content-center">
                                <uploader v-model="user.image" :apiUrl="`${$axios.defaults.baseURL}/user/${user._id}/upload-image`" @presigned="fetchUser($event.user)"></uploader>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="pl-lg-4">
                                    <div class="row justify-content-center">
                                        <div class="col-lg-6 text-center">
                                            <a href="#!" class="btn btn-success" @click="saveUser">Save user</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
...
export default {
    ...
    async asyncData({$axios, params}) {
        ...
        var { user } = await $axios.$get(`/user/${params.id}`);
    ...
    methods: {
        saveUser() {
            ...
            this.$axios.$post(`/user/${id}/update`, this.user).then((response) => {
